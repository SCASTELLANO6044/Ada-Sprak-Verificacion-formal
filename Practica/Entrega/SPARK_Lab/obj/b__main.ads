...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#8ec32a9d#;
   ...
   u00105 : constant Version_32 := 16#85bb657c#;
   pragma Export (C, u00105, "tests_addtenxtimesB");
   ...
   u00122 : constant Version_32 := 16#49b5173b#;
   pragma Export (C, u00122, "pkg_addtenxtimesB");
   u00123 : constant Version_32 := 16#95669c28#;
   pragma Export (C, u00123, "pkg_addtenxtimesS");
   ...
   u00128 : constant Version_32 := 16#88aee475#;
   pragma Export (C, u00128, "tests_fromnegativetozeroB");
   u00129 : constant Version_32 := 16#b7e7d4d7#;
   pragma Export (C, u00129, "pkg_fromnegativetozeroB");
   u00130 : constant Version_32 := 16#a45b5a79#;
   pragma Export (C, u00130, "pkg_fromnegativetozeroS");
   u00131 : constant Version_32 := 16#1f968dac#;
   pragma Export (C, u00131, "tests_medianB");
   u00132 : constant Version_32 := 16#d1b29033#;
   pragma Export (C, u00132, "pkg_medianB");
   u00133 : constant Version_32 := 16#62604066#;
   pragma Export (C, u00133, "pkg_medianS");
   ...
   u00136 : constant Version_32 := 16#dcad03aa#;
   pragma Export (C, u00136, "tests_substracttenaddtenB");
   u00137 : constant Version_32 := 16#4114354e#;
   pragma Export (C, u00137, "pkg_substracttenaddtenB");
   u00138 : constant Version_32 := 16#ba32a195#;
   pragma Export (C, u00138, "pkg_substracttenaddtenS");
   ...
   --  pkg_addtenxtimes%s
   --  pkg_addtenxtimes%b
   --  pkg_fromnegativetozero%s
   --  pkg_fromnegativetozero%b
   --  pkg_median%s
   --  pkg_median%b
   --  pkg_substracttenaddten%s
   --  pkg_substracttenaddten%b
   --  tests_addtenxtimes%b
   --  tests_fromnegativetozero%b
   --  tests_median%b
   --  tests_substracttenaddten%b
   --  main%b
